# 🔍 AUDIT COMPLET JOELTOM VPN — 11 Juillet 2026
...
- ✅ Configuration standardisée (JOELTOM_DB_DIR)
...
- ✅ Chemins standardisés (JOELTOM_DB_DIR = /etc/joeltom-web)
...
```yaml
Services configurés:
- joeltom-web (Node 20 Alpine, port 2087)
- joeltom-core-bot (Python 3.11, Telegram)
- joeltom-deploy-bot (Python 3.11, Deploy multi-VPS)
- joeltom-whatsapp-bot (Python 3.11 + Twilio Flask)
- nginx (Reverse proxy, Alpine)

Volumes:
- joeltom-db → /etc/joeltom-web ✅ Standardisé
- joeltom-backups → /tmp/joeltom_backups ✅ Persist
...
- [ ] Vérifier les backups: `ls -lh /tmp/joeltom_backups/`
