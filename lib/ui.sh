#!/bin/bash
#=========================================================
# JOELTOM VPS — lib/ui.sh · DESIGN SYSTEM "NEBULA" v6.0
...
movivip_contacts(){
    mv_center "${MV_DIM}📢${MV_R} ${MV_WHT}t.me/MoviVIPNetwork${MV_R} ${MV_DIM}·${MV_R} ${MV_WHT}t.me/MoviVIPNet${MV_R} ${MV_DIM}·${MV_R} ${MV_WHT}@JOELTOM${MV_R}"
