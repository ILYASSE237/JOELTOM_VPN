...
# ── Datos de contacto oficiales JOELTOM VPS ──
MOVIVIP_CANAL="https://@JOELTOM"
MOVIVIP_GRUPO="https://@JOELTOM"
MOVIVIP_SOPORTE="https://t.me/JOELTOM"
MOVIVIP_WEB="https://JOELTOM VPS"
...
movivip_footer() {
    ...
    echo ""
    echo -e "${GRAY} ──────────────────────────────────────────────────────────${RESET}"
    echo -e " ${CYAN}📢${RESET}${WHITE} Canal:${RESET} @JOELTOM ${GRAY}|${RESET} ${WHITE}Grupo:${RESET} @JOELTOM ${GRAY}|${RESET} ${WHITE}@JOELTOM${RESET}"
    echo -e " ${CYAN}🌐${RESET}${WHITE} Web:${RESET} JOELTOM VPS ${GRAY}|${RESET} ${CYAN}📱${RESET}${WHITE} WhatsApp:${RESET} +57 311 700 8185"
...
movivip_contacts() {
    local GRAY="\e[1;90m" WHITE="\e[1;97m" CYAN="\e[1;96m" RESET="\e[0m"
    echo -e " ${GRAY}📢${RESET} ${WHITE}@JOELTOM${RESET} ${GRAY}·${RESET} ${WHITE}@JOELTOM${RESET} ${GRAY}·${RESET} ${WHITE}@JOELTOM${RESET}"
    echo -e " ${GRAY}🌐${RESET} ${WHITE}JOELTOM VPS${RESET} ${GRAY}·${RESET} ${CYAN}📱${RESET} ${WHITE}+57 311 700 8185${RESET}"
}
...
movivip_sub_header() {
    ...
    if declare -F mv_center >/dev/null 2>&1; then
        ...
        echo -e " 📢 @JOELTOM · @JOELTOM · @JOELTOM"
        echo -e " 🌐 JOELTOM VPS · 📱 +57 311 700 8185"
        echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${RESET}"
    fi
}
...
movivip_soporte_screen() {
    ...
    mv_header "Soporte JOELTOM" "Centro de Ayuda · Compatibilidad · Contactos" "v${VERSION:-6.0}"

    # ── CONTACTO OFICIAL ──
    mv_section "📞 CONTACTO OFICIAL"
    printf "   ${MV_CYN}📢 Canal oficial ....... ${MV_WHT}@JOELTOM${MV_R}\n"
    printf "   ${MV_CYN}👥 Grupo oficial ........ ${MV_WHT}@JOELTOM${MV_R}\n"
    printf "   ${MV_GRN}💬 Soporte directo ...... ${MV_WHT}@JOELTOM  (t.me/JOELTOM)${MV_R}\n"
    printf "   ${MV_CYN}🌐 Sitio web ............ ${MV_WHT}https://JOELTOM VPS${MV_R}\n"
