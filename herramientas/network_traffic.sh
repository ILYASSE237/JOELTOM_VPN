...
#=========================================================
#   JOELTOM VPS - CONSUMO EN TIEMPO REAL
...
if [[ "$1" == "--refresh-only" ]]; then
    ...
    while true; do
        ...
        clear
        echo -e "${CYAN}═══════════════════════════════════════════════════════════════${RESET}"
        echo -e "${WHITE}   📊 CONSUMO EN TIEMPO REAL — ${GRAY}JOELTOM  (Ctrl+C para salir)${RESET}"
        echo -e "${CYAN}═══════════════════════════════════════════════════════════════${RESET}"
        echo ""
...
clear
echo -e "${CYAN}═══════════════════════════════════════════════════════════════${RESET}"
echo -e "${WHITE}        📊 CONSUMO DE RED EN TIEMPO REAL — ${GRAY}JOELTOM${RESET}"
echo -e "${CYAN}═══════════════════════════════════════════════════════════════${RESET}"
echo ""
