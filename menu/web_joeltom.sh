#!/bin/bash
# ============================================================
#  Menu 18 — JOELTOM_VPN Web
#  Manages the JOELTOM_VPN Web panel from terminal.
# ============================================================
...
JOELTOM_WEB_DIR="/opt/joeltom-web"
CONFIG_DIR="/etc/joeltom-web"
...
# ("Source install script not found"). Corrigé vers le dépôt officiel JOELTOM VPN.
...
resolve_web_source_dir() {
  ...
  if GIT_TERMINAL_PROMPT=0 git clone --depth 1 "$JOELTOM_REPO_URL" "$TMP_WEB_SRC" >/dev/null 2>&1; then
...
resolve_web_installer() {
  ...
  local candidates=(
    "$base/../joeltom-web/install.sh"
    "$base/../install.sh"
    "$base/../../joeltom-web/install.sh"
    "$base/../../install.sh"
    "/usr/local/sbin/joeltom-web/install.sh"
    "/usr/local/sbin/install.sh"
    "/opt/joeltom-web/install.sh"
    "/root/joeltom-web/install.sh"
    "/root/install.sh"
  )
  ...
  if command -v git >/dev/null 2>&1; then
    rm -rf "$TMP_WEB_SRC"
    if GIT_TERMINAL_PROMPT=0 git clone --depth 1 "$JOELTOM_REPO_URL" "$TMP_WEB_SRC" >/dev/null 2>&1; then
      candidate="$TMP_WEB_SRC/joeltom-web/install.sh"
      if [ -f "$candidate" ]; then
        echo "$candidate"
        return 0
      fi
...
function joeltom_web_menu() {
  ...
  echo -e "${LN}┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓${NC}"
  echo -e "${LN}┃${NC} ${BG}           JOELTOM VPN WEB — MENU 18           ${NC} ${LN}┃${NC}"
  echo -e "${LN}┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛${NC}"
  echo -e "${LN}┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓${NC}"
  ...
  if ! web_is_installed; then
    echo -e "${LN}┃${NC} ${YL}  JOELTOM_VPN Web is NOT installed.${NC}"
    echo -e "${LN}┃${NC}"
    echo -e "${LN}┃${NC} ${GR}[1]${NC} • Install JOELTOM_VPN Web"
  ...
  echo -e "${LN}┃${NC} [7] • Mettre à jour JOELTOM_VPN Web"
  echo -e "${LN}┃${NC} [8] • Désinstaller JOELTOM_VPN Web"
...
function ntw_install() {
  clear
  echo -e "${LN}┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓${NC}"
  echo -e "${LN}┃${NC} ${BG}         INSTALLATION — JOELTOM VPN WEB         ${NC} ${LN}┃${NC}"
  echo -e "${LN}┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛${NC}"
  echo ""
  echo -e "  Ce script va installer l'interface web JOELTOM_VPN."
  ...
  if [ "$NODE_MAJOR" -lt 20 ]; then
    ...
    echo -e "  ${GR}curl -o /root/node_upgrade_fix.sh https://raw.githubusercontent.com/joeltom-tech/JOELTOM_VPN/main/node_upgrade_fix.sh${NC}"
    echo -e "  ${GR}bash /root/node_upgrade_fix.sh${NC}"
    echo ""
    wait_key
    joeltom_web_menu
  ...
  if installer="$(resolve_web_installer)"; then
    ...
    echo -e "    - /opt/joeltom-web/install.sh"
    echo -e "    - /root/joeltom-web/install.sh"
...
function ntw_manager_admin() {
  ...
  local token
  token=$(ntw_get_token) || { joeltom_web_menu; return; }
...
function ntw_update() {
  clear
  echo -e "${LN}┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓${NC}"
  echo -e "${LN}┃${NC} ${BG}          MISE À JOUR JOELTOM VPN WEB           ${NC} ${LN}┃${NC}"
  echo -e "${LN}┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛${NC}"
  echo ""
  ...
  sed -i "s|const PUBLIC_DIR = .*|const PUBLIC_DIR = '/opt/joeltom-web/public';|g" \
...
function ntw_uninstall() {
  clear
  echo -e "${LN}┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓${NC}"
  echo -e "${LN}┃${NC} ${BG}          DÉSINSTALLER JOELTOM VPN WEB          ${NC} ${LN}┃${NC}"
  echo -e "${LN}┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛${NC}"
  echo ""
  ...
  echo -e "  ${GR}[OK] JOELTOM_VPN Web désinstallé.${NC}"
  wait_key
  menu
}
