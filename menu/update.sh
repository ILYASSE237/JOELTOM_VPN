...
echo -e "\n${LN}┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓${NC}"
echo -e "${LN}┃${NC} ${GR}         MISE À JOUR JOELTOM VPN WEB            ${NC}${LN}┃${NC}"
echo -e "${LN}┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛${NC}"
...
if [ -d "$NEXUS_WEB_DIR" ] && [ -f "$NEXUS_WEB_DIR/dist/server/index.js" ]; then
  ...
  if git clone --depth 1 "$NEXUS_REPO_URL" "$NTW_TMP" >/dev/null 2>&1; then
    if [ -d "$NTW_TMP/nexus-web" ]; then
      ...
      sed -i "s|const PUBLIC_DIR = .*|const PUBLIC_DIR = '/opt/joeltom-web/public';|g" "$NEXUS_WEB_DIR/server/index.ts" 2>/dev/null || true
