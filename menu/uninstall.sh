...
echo -e "${RD}┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓${NC}"
echo -e "${RD}┃${NC} ${WH}       DÉSINSTALLATION TOTALE : JOELTOM VPN      ${NC} ${RD}┃${NC}"
echo -e "${RD}┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛${NC}"
echo -e ""
...
systemctl stop xray zivpn joeltom_bot dropbear stunnel4 ws-dropbear ws-stunnel >/dev/null 2>&1
systemctl disable xray zivpn joeltom_bot dropbear stunnel4 ws-dropbear ws-stunnel >/dev/null 2>&1
sleep 1
echo -e "${GR}[ OK ]${NC}"

echo -ne " ${WH}▪ Éradication des bases de données...${NC}"
rm -rf /etc/xray /etc/zivpn /etc/slowdns /etc/joeltom_bot /root/joeltom_bot_engine /root/nexus_core_bot
rm -f /etc/systemd/system/joeltom_bot.service
sleep 1
echo -e "${GR}[ OK ]${NC}"
