#!/usr/bin/env python3
"""
JOELTOM VPN — Bot WhatsApp v2 (Twilio + Flask)
Gestion SSH/XRAY/ZIVPN + Gestion revendeurs via WhatsApp
Contact WhatsApp: wa.me/237654145540
Groupe: https://chat.whatsapp.com/GXtrKVZpwkOGurHUDsCObz?s=cl&p=a&mlu=0&ilr=0
"""
...
CONFIG_PATH = os.environ.get('JOELTOM_WA_CONFIG', '/etc/joeltom_whatsapp_bot/config.json')
DEFAULT_CFG = {'twilio_account_sid': '', 'twilio_auth_token': '', 'twilio_whatsapp_number': '', 'admin_whatsapp_number': '', 'bot_password': ''}
...
if not TWILIO_SID or not TWILIO_TOKEN:
    raise SystemExit('Missing Twilio credentials. Set JOELTOM_WA_CONFIG or /etc/joeltom_whatsapp_bot/config.json')
...
HELP_ADMIN = """*JOELTOM VPN — Commandes Admin*
...
HELP_RESELLER = """*JOELTOM VPN — Commandes Revendeur*
...
def whatsapp_webhook():
    ...
    try:
        ...
        resp.message("❌ Erreur interne. Réessayez ou contactez @ILYASSE237")
    return str(resp)
...
if __name__ == '__main__':
    ...
    logger.info(f"JOELTOM WhatsApp Bot v2 starting on port {port}...")
