#!/usr/bin/env python3
"""
JOELTOM VPN — Bot Telegram Principal v2
...
logger = logging.getLogger('joeltom-bot')

CONFIG_PATH = os.environ.get('JOELTOM_BOT_CONFIG', '/etc/joeltom_bot/config.json')
...
if not BOT_TOKEN:
    raise SystemExit('Missing Telegram bot token. Set JOELTOM_BOT_CONFIG or /etc/joeltom_bot/config.json')
...
BANNER = "🛡 <b>JOELTOM VPN</b> — Panel Telegram\n📲 @ILYASSE237"
...
if __name__ == '__main__':
    logger.info("JOELTOM VPN Bot v2 starting...")
