...
SOCIAL = {
    ...
    'youtube': 'https://www.youtube.com/@JOELTOM',
...
OFFICIAL_MSG = (
    "⚠️ *COMUNICADO OFICIAL JOELTOM VPS*\n"
    "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n"
...
async def cmd_set_welcome_text(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        "📌 `{brand}` = la MARCA que pusiste en el config (ej: JOELTOM VPS).\n"
...
async def cmd_start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not is_admin(update.effective_user.id):
        await update.message.reply_text(
            "🤖 *JOELTOM Notification Bot*\n\n"
            "Soy el bot de notificaciones de JOELTOM VPS.\n"
...
async def cmd_help(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not is_admin(update.effective_user.id):
        await update.message.reply_text(
            "🤖 *JOELTOM Notification Bot*\n\n"
            "Notificaciones y reportes de JOELTOM VPS.\n"
            f"🌐 {SOCIAL['web']}",
            parse_mode=ParseMode.MARKDOWN
        )
        return
...
# =============================================================================
def main():
    logger.info("Starting JOELTOM Notification Bot v3.0...")
