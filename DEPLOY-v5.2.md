...
| `menu.sh` | Dashboard **sin box ╔═╗** → separadores ─── estilo selector (unificación visual, cero desbordes); marca centrada `🛡️ JOELTOM VPS v5.0 🛡️` (doble escudo); PROTOCOLOS en 2 columnas **con puertos restaurados** ([22], [UDP 5667], [53/5300], [443], [7200,7300], [2100], Hysteria dinámico); subtítulo sin duplicar |
