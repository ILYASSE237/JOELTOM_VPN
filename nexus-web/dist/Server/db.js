...
// ─── BUG FIX: standardized to JOELTOM_DB_DIR (was NEXUS_DB_DIR → /etc/nexus-tunnel-web)
// docker-compose.yml now mounts the volume to /etc/joeltom-web to match this default.
