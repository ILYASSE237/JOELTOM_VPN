  ...
  return (
    <div className="landing-page">
      ...
      <section className="hero-section">
        <div className="hero-content">
          ...
          <p className="hero-subtitle">
            JOELTOM VPN vous offre SSH, VLESS, VMESS et plus encore — avec des serveurs rapides,
          ...
          <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
            ...
            <a href={`https://wa.me/237682229367?text=Bonjour,%20je%20veux%20un%20VPN%20JOELTOM`}
      ...
      <section id="features" className="features-section">
        <h2 className="section-title">Pourquoi choisir JOELTOM VPN ?</h2>
      ...
      <footer className="landing-footer">
        ...
        <p style={{ color: 'var(--text-muted)', fontSize: '0.8rem', marginTop: '0.5rem' }}>
          © {new Date().getFullYear()} JOELTOM VPN — Tous droits réservés
        </p>
      </footer>
    </div>
  );
